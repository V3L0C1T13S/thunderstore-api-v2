...
impl PackageCard {
    pub fn new(categories: Vec<crate::models::PackageCategory>, community_identifier: String, community_name: String, description: String, download_count: i32, image_src: Option<String>, is_deprecated: bool, is_nsfw: bool, is_pinned: bool, last_updated: String, namespace: String, package_name: String, rating_score: i32, team_name: String) -> PackageCard {
        PackageCard {
            categories,
